...
A hardware prototype was developed using Arduino Uno, push buttons, LEDs, a buzzer, and a servo motor to demonstrate the real-world implementation of the digital locker system.
